...
**/
function createFieldSelector( fieldApi ){
	if( !gridInfoByField ){
		throw( "convertGridInfoMap() has not been called" );
	} else if( !gridInfoByField.hasOwnProperty( fieldApi )){
	...
	return( "td[name=" + gridInfoByField[fieldApi].fieldId + "]" );
}
...
**/
function createFieldInputSelector( fieldApi ){
	return( createFieldSelector( fieldApi ) + " :input" );
}
