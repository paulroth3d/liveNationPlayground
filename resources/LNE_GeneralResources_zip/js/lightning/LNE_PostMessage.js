(function(){
	...
	**/
	...
	var LNE_PostMessage = function( pageName, messageType, isSuccessful, payload ){
	...
	**/
	LNE_PostMessage.prototype.dispatch = function( targetWindow, targetDomain ){
		if( !targetDomain ){
			targetDomain = '*';
		}
		var dataStr = "";
	...
	**/
	LNE_PostMessage.prototype.matchesPage = function( pageName ){
	...
	**/
	LNE_PostMessage.prototype.matchesMessageType = function( messageType ){
	...
	**/
	LNE_PostMessage.prototype.matchesPageMessage = function( pageName, messageType ){
	...
	**/
	LNE_PostMessage.prototype.getMessageOrigin = function( evt ){
	...
	**/
	LNE_PostMessage.prototype.parse = function( evt ){
		var results = null;
		try {
			if( !evt.data.sender ){
	...
	window.LNE_PostMessage = LNE_PostMessage;
})();