(function(){
	 ...
	 **/
	var LNE_MessagePostOffice = function( handlerScope ){
		if( !handlerScope ){
	 ...
	 **/
	LNE_MessagePostOffice.prototype.addTypeHandler = function( messageType, handler ){
		if( messageType ){
	 ...
	 **/
	LNE_MessagePostOffice.prototype.receiveMessage = function( postMessage ){
	 ...
	 *  @param window
	 **/
	LNE_MessagePostOffice.prototype.listenForPostEvents = function( targetWindow ){
		targetWindow.addEventListener('message',this.receiveMessage.bind(this),false);
	};
	
	window.LNE_MessagePostOffice = LNE_MessagePostOffice;
})();