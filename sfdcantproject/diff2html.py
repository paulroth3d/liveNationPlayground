...
<body>
	<h1>SFDC/GIT Change report</h1>
	
	<h3>The following is a list of changes that are in SalesForce but not in Version Control</h3>
	
	<p>Quick reminder: Untracked files have never been added to Version Control, while Modified files have been at some point.</p>
	
	<pre><!--###GIT_STATUS###--></pre>
	
	<h3>Individual File Changes</h3>

	<p><b>Items on the left is what is in version control. Items on the right is what is currently in SalesForce</b></p>
