...
/*
//Filename:grunt_src/bonushelpersUS641.js
//-- #	#	#	#	#	#	#	#	#	#	#	#	#	#	#	#	#	#	#
*/
...
lneBonusHelp.prototype = {
    ...
    checkRange: function() {
        ...
        if (related.length > 1 && currentRec.rangeStart && parseInt(currentRec.rangeStart) === 0) {
            results.push('true');
        } else {
            results.push('false');
        }
        ...
        if (parseInt(currentRec.rangeStart) && parseInt(currentRec.rangeEnd)) {
            ...
            //Remove the start !=  end rule
            // if (parseInt(currentRec.rangeStart) === parseInt(currentRec.rangeEnd)) {
            //     if (bh.errorMsgs.indexOf('startAndEndMatch') < 0) {
            //         bh.errorMsgs.push('startAndEndMatch');
            //     }
            // } else {
            //     if (bh.errorMsgs.indexOf('startAndEndMatch') >= 0) {
            //         bh.errorMsgs.splice(bh.errorMsgs.indexOf('startAndEndMatch'), 1);
            //     }
            // }
    ...
    checkForMultipleBlankEndPoints: function() {
        ...
        if (endPoints.indexOf('blank') >= 0 && !currentRec.rangeEnd) {
            ...
            if (bh.fieldInfo.uniqueness == 'artistretro' || bh.fieldInfo.uniqueness == 'artistdeal' && related[0].Type__c== "Retro" ){
    ...
    popRelatedBonusRecordsArray: function() {
        ...
        for (var ii = 0; ii < $rows.length; ii++) {
            // focus = false;
            // if (jq($rows[ii]).attr('id') === jq(bh.targetRow).attr('id')) {
            //     focus = true;
            // }
            // if (!focus) {
...
/*
//Filename:grunt_src/ArtistDeal_US641.js
//-- #	#	#	#	#	#	#	#	#	#	#	#	#	#	#	#	#	#	#
*/
convertGridInfoMap();
